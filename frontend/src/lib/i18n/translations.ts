...
const en = {
  ...
  subscriptionEnded: "Your previous subscription has ended.",
  subscriptionPaymentFailed: "Your last payment did not go through.",
...
const nl: Dictionary = {
  ...
  subscriptionEnded: "Je vorige abonnement is beëindigd.",
  subscriptionPaymentFailed: "Je laatste betaling is niet gelukt.",
...
const de: Dictionary = {
  ...
  subscriptionEnded: "Ihr vorheriges Abonnement ist beendet.",
  subscriptionPaymentFailed: "Ihre letzte Zahlung ist fehlgeschlagen.",
...
const fr: Dictionary = {
  ...
  subscriptionEnded: "Votre abonnement précédent a pris fin.",
  subscriptionPaymentFailed: "Votre dernier paiement n’a pas abouti.",
